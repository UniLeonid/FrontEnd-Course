...
export default function PortfolioPage() {
    ...
    const currentBlockSetter = (id: number, element: React.JSX.Element, height: number) => {
        return () => {
    ...
    const containerStyle = currentBlock.height ? { height: currentBlock.height } : {};

    return (
        <main>
            <div className='container' id='portfolio-container' style={containerStyle}>
