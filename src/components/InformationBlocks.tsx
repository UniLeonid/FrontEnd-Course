...
export function BioInformationBlock() {
    return (
        <InformationBlock>
            <p>
                <b>Key skills:</b> Java, JUnit, Spring Framework, Hibernate, SQL, Gradle, Maven,
                Kafka, RabbitMQ, Git
            </p>
            <p>
            ...
            <p>
                <b>Hobby:</b> books, teaching programming, learning internals of Java and Spring
                Framework
            </p>
        </InformationBlock>
    );
    ...
    return (
        <InformationBlock id='contacts-block'>
            ...
            <a id='email' href='mailto:admin@smashup.ru' target='_blank'>
                <Image className='contacts-logo inverted-logo' src={emailLogo} alt='Email logo' />
            </a>
        </InformationBlock>
    );
}
